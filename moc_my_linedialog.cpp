...
QMetaObject* MyLineDialog::staticMetaObject()
{
    ...
    static const QUMethod slot_3 = {"OnSetConnectStyle", 1, param_slot_3 };
    static const QUMethod slot_4 = {"ChangeSetChecked", 0, 0 };
	...
	{ "OnSetConnectStyle(int)", &slot_3, QMetaData::Public },
	{ "ChangeSetChecked()", &slot_4, QMetaData::Public }
    };
...
bool MyLineDialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 3: OnSetConnectStyle((int)static_QUType_int.get(_o+1)); break;
    case 4: ChangeSetChecked(); break;
    default:
