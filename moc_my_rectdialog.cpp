...
QMetaObject* MyRectDialog::staticMetaObject()
{
    ...
    static const QUMethod slot_2 = {"OnSetFillStyle", 1, param_slot_2 };
    static const QUParameter param_slot_3[] = {
	{ "type", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_3 = {"OnSetBoundaryStyle", 1, param_slot_3 };
    static const QUParameter param_slot_4[] = {
	{ "type", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_4 = {"OnSetJoinStyle", 1, param_slot_4 };
    static const QUParameter param_slot_5[] = {
	{ "type", &static_QUType_int, 0, QUParameter::In }
    };
    static const QUMethod slot_5 = {"OnSetFillColor", 1, param_slot_5 };
    static const QMetaData slot_tbl[] = {
	{ "OnSetBoundaryWidth(int)", &slot_0, QMetaData::Public },
	{ "OnSetDrawType(int)", &slot_1, QMetaData::Public },
	{ "OnSetFillStyle(int)", &slot_2, QMetaData::Public },
	{ "OnSetBoundaryStyle(int)", &slot_3, QMetaData::Public },
	{ "OnSetJoinStyle(int)", &slot_4, QMetaData::Public },
	{ "OnSetFillColor(int)", &slot_5, QMetaData::Public }
    };
...
bool MyRectDialog::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 2: OnSetFillStyle((int)static_QUType_int.get(_o+1)); break;
    case 3: OnSetBoundaryStyle((int)static_QUType_int.get(_o+1)); break;
    case 4: OnSetJoinStyle((int)static_QUType_int.get(_o+1)); break;
    case 5: OnSetFillColor((int)static_QUType_int.get(_o+1)); break;
    default:
